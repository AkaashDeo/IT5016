...
def average_grade(records):                            # Parameter: records is expected to be a list or tuple of tuples (similar to the students tuple).
    ...
    return total_grade / len(records)                  # This function returns the number of records (tuples) in records.

students = ( 
    ('James', 20, 85)
    ('Sumeet', 22, 90)                                 # students Tuple: This is a tuple of tuples. Each inner tuple represents a record for a student with the values.
    ('Modi', 20, 95)
)
